...
import type { Player, TriviaGameSettings } from "../../utils/types";
...
export default function Waiting({
  ...
  updateGameSettings: (settings: TriviaGameSettings) => void;
  error: string;
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="mb-2">
              ...
              >
                {["Multiple Choice", "Short Answer"].map((val) => (
                  <option key={val} value={val}>
                    {val}
                  </option>
                ))}
            ...
            {/* Topic */}
            <div className="mb-2">
              <label className="block mb-1 font-medium text-sm">Topic</label>
              <input
                className="w-full border rounded mt-2 p-2 cursor-pointer bg-black text-sm"
